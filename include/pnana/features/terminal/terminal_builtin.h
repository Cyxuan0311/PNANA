...
private:
    ...
    static std::string executeCd(const std::vector<std::string>& args, std::string& current_directory);
    static std::string executeLs(const std::vector<std::string>& args, const std::string& current_directory);
    static std::string executeCat(const std::vector<std::string>& args, const std::string& current_directory);
