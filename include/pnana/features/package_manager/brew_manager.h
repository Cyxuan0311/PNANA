#ifndef PNANA_FEATURES_PACKAGE_MANAGER_BREW_MANAGER_H
#define PNANA_FEATURES_PACKAGE_MANAGER_BREW_MANAGER_H
...
class BrewManager : public PackageManagerBase {
  public:
    BrewManager();
    ~BrewManager() = default;
  ...
  private:
    ...
    std::vector<Package> parseBrewListOutput(const std::string& output);
...
#endif // PNANA_FEATURES_PACKAGE_MANAGER_BREW_MANAGER_H
