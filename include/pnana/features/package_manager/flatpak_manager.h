#ifndef PNANA_FEATURES_PACKAGE_MANAGER_FLATPAK_MANAGER_H
#define PNANA_FEATURES_PACKAGE_MANAGER_FLATPAK_MANAGER_H
...
class FlatpakManager : public PackageManagerBase {
  public:
    FlatpakManager();
  ...
  private:
    ...
    std::vector<Package> parseFlatpakOutput(const std::string& output);
...
#endif // PNANA_FEATURES_PACKAGE_MANAGER_FLATPAK_MANAGER_H