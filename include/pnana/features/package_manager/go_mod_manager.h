#ifndef PNANA_FEATURES_PACKAGE_MANAGER_GO_MOD_MANAGER_H
#define PNANA_FEATURES_PACKAGE_MANAGER_GO_MOD_MANAGER_H
...
class GoModManager : public PackageManagerBase {
  public:
    GoModManager();
  ...
  private:
    ...
    std::vector<Package> parseGoModOutput(const std::string& output);
...
#endif // PNANA_FEATURES_PACKAGE_MANAGER_GO_MOD_MANAGER_H