#ifndef PNANA_FEATURES_PACKAGE_MANAGER_COMPOSER_MANAGER_H
#define PNANA_FEATURES_PACKAGE_MANAGER_COMPOSER_MANAGER_H
...
class ComposerManager : public PackageManagerBase {
  public:
    ComposerManager();
  ...
  private:
    ...
    std::vector<Package> parseComposerOutput(const std::string& output);
...
#endif // PNANA_FEATURES_PACKAGE_MANAGER_COMPOSER_MANAGER_H