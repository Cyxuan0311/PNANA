#ifndef PNANA_FEATURES_PACKAGE_MANAGER_PNPM_MANAGER_H
#define PNANA_FEATURES_PACKAGE_MANAGER_PNPM_MANAGER_H
...
class PnpmManager : public PackageManagerBase {
  public:
    PnpmManager();
  ...
  private:
    ...
    std::vector<Package> parsePnpmOutput(const std::string& output);
...
#endif // PNANA_FEATURES_PACKAGE_MANAGER_PNPM_MANAGER_H