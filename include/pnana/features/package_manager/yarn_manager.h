#ifndef PNANA_FEATURES_PACKAGE_MANAGER_YARN_MANAGER_H
#define PNANA_FEATURES_PACKAGE_MANAGER_YARN_MANAGER_H
...
// Yarn (Node.js) 包管理器
class YarnManager : public PackageManagerBase {
  public:
    YarnManager();
    ~YarnManager() = default;
  ...
  private:
    ...
    std::vector<Package> parseYarnListOutput(const std::string& output);
...
#endif // PNANA_FEATURES_PACKAGE_MANAGER_YARN_MANAGER_H
