#ifndef PNANA_FEATURES_PACKAGE_MANAGER_GEM_MANAGER_H
#define PNANA_FEATURES_PACKAGE_MANAGER_GEM_MANAGER_H
...
class GemManager : public PackageManagerBase {
  public:
    GemManager();
  ...
  private:
    ...
    std::vector<Package> parseGemOutput(const std::string& output);
...
#endif // PNANA_FEATURES_PACKAGE_MANAGER_GEM_MANAGER_H