#ifndef PNANA_FEATURES_PACKAGE_MANAGER_PIP_MANAGER_H
#define PNANA_FEATURES_PACKAGE_MANAGER_PIP_MANAGER_H
...
// Pip 包管理器
class PipManager : public PackageManagerBase {
  public:
    PipManager();
    ~PipManager() = default;
  ...
  private:
    ...
    // 解析 pip list 输出
    std::vector<Package> parsePipListOutput(const std::string& output);
...
#endif // PNANA_FEATURES_PACKAGE_MANAGER_PIP_MANAGER_H
