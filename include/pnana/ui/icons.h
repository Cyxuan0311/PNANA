...
constexpr const char* LLVM = "\ue69d";          // nf-dev-llvm
...
// 更多 Linux 发行版图标
constexpr const char* KALI = "\uf17c";                // nf-fa-linux (Kali Linux)
constexpr const char* PARROT = "\uf17c";              // nf-fa-linux (Parrot OS)
constexpr const char* LUBUNTU = "\uf31b";             // nf-fa-ubuntu (Lubuntu)
constexpr const char* XUBUNTU = "\uf31b";             // nf-fa-ubuntu (Xubuntu)
constexpr const char* KUBUNTU = "\uf31b";             // nf-fa-ubuntu (Kubuntu)
constexpr const char* UBUNTU_MATE = "\uf31b";         // nf-fa-ubuntu (Ubuntu MATE)
constexpr const char* ZORIN = "\uf17c";               // nf-fa-linux (Zorin OS)
constexpr const char* GARUDA = "\uf303";              // nf-fa-archlinux (Garuda Linux)
constexpr const char* ARTIX = "\uf303";               // nf-fa-archlinux (Artix Linux)
constexpr const char* FEDORA_SILVERBLUE = "\uf30a";   // nf-fa-fedora (Fedora Silverblue)
constexpr const char* FEDORA_KINOITE = "\uf30a";      // nf-fa-fedora (Fedora Kinoite)
constexpr const char* ROCKY = "\uf304";               // nf-fa-centos (Rocky Linux)
constexpr const char* ALMA = "\uf304";                // nf-fa-centos (AlmaLinux)
constexpr const char* DEBIAN_UNSTABLE = "\uf306";     // nf-fa-debian (Debian Unstable)
constexpr const char* DEBIAN_TESTING = "\uf306";      // nf-fa-debian (Debian Testing)
constexpr const char* KNOPPIX = "\uf306";             // nf-fa-debian (Knoppix)
constexpr const char* PARDUS = "\uf17c";              // nf-fa-linux (Pardus Linux)
constexpr const char* ALT_LINUX = "\uf17c";           // nf-fa-linux (ALT Linux)
constexpr const char* SLACKWARE = "\uf17c";           // nf-fa-linux (Slackware)
constexpr const char* CRUX = "\uf17c";                // nf-fa-linux (CRUX)
constexpr const char* FUNTOO = "\uf30f";              // nf-fa-gentoo (Funtoo)
constexpr const char* SOLUS = "\uf17c";               // nf-fa-linux (Solus)
constexpr const char* NIXOS = "\uf17c";               // nf-fa-linux (NixOS)
constexpr const char* GUIX = "\uf17c";                // nf-fa-linux (Guix System)
constexpr const char* OPENSUSE_TUMBLEWEED = "\uf314"; // nf-fa-suse (openSUSE Tumbleweed)
constexpr const char* OPENSUSE_LEAP = "\uf314";       // nf-fa-suse (openSUSE Leap)
constexpr const char* MAGEIA = "\uf17c";              // nf-fa-linux (Mageia)
constexpr const char* ROSA = "\uf17c";                // nf-fa-linux (ROSA Linux)
...
constexpr const char* FLATPAK = "\uf17c";   // nf-fa-linux (Flatpak)
constexpr const char* SNAP = "\uf31b";      // nf-fa-ubuntu (Snap)
