...
RegionManager::RegionManager()
    : current_region_(EditorRegion::CODE_AREA),
      previous_region_(EditorRegion::CODE_AREA),
      tab_area_enabled_(false),
      file_browser_enabled_(false),
      terminal_enabled_(false),
      help_window_enabled_(false),
      tab_index_(0) {
}
