...
AnimationMenu::AnimationMenu(Theme& theme) : theme_(theme) {
    effects_ = {
        ...
        {"sparkle", "Sparkle", "Twinkling star-like sparkles"},
        {"gradient", "Gradient", "Smooth gradient wave animation"},
        {"typewriter", "Typewriter", "Sequential typewriter reveal"},
        {"expand", "Expand", "Expanding from center outward"},
        {"contract", "Contract", "Contracting toward center"},
        {"rotate", "Rotate", "Rotating color wheel effect"},
        {"zigzag", "Zigzag", "Zigzag pattern animation"},
        {"pixelate", "Pixelate", "Pixel-by-pixel reveal effect"},
        {"dissolve", "Dissolve", "Random dissolve transition"},
        {"slide", "Slide", "Sliding reveal from edges"},
        {"zoom", "Zoom", "Zooming in/out animation"},
        {"blur", "Blur", "Blur to sharp focus transition"},
        {"elastic", "Elastic", "Elastic bouncy animation"},
        {"fluid", "Fluid", "Smooth fluid-like motion"},
        {"particle", "Particle", "Particle system animation"},
        {"lightning", "Lightning", "Random lightning flashes"},
        {"snow", "Snow", "Gentle snowfall animation"},
        {"firefly", "Firefly", "Random firefly-like glows"},
        {"vortex", "Vortex", "Swirling vortex effect"},
        {"kaleidoscope", "Kaleidoscope", "Kaleidoscopic pattern shifts"},
    };
}
