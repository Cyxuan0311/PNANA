...
LuaAPI::LuaAPI(core::Editor* editor) 
    : editor_(editor), engine_(nullptr) {
}
...
void LuaAPI::registerKeymap(const std::string& mode, const std::string& keys, const std::string& callback) {
