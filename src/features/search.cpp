...
void SearchEngine::search(const std::string& pattern,
...
void SearchEngine::searchRegex(const std::string& pattern,
                               const std::vector<std::string>& lines) {
    try {
...
size_t SearchEngine::replaceAll(const std::string& replacement,
                               std::vector<std::string>& lines) {
    size_t count = 0;
