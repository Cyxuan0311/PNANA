...
std::vector<Snippet> getDartSnippets() {
    return {
        ...
        {"void", "void ${1:functionName}(${2:parameters}) {\n    ${3:// code}\n}",
         "Void function"},
        {"func", "${1:ReturnType} ${2:functionName}(${3:parameters}) {\n    ${4:return ${5:value};}\n}",
         "Function with return"},
        {"funca", "${1:ReturnType} ${2:functionName}(${3:parameters}) => ${4:expression};",
         "Arrow function"},
        {"async", "Future<${1:ReturnType}> ${2:functionName}(${3:parameters}) async {\n    ${4:// code}\n}",
         "Async function"},
        {"main", "void main() {\n    ${1:// code}\n}",
         "Main function"},
        {"runapp", "void main() {\n    runApp(${1:MyApp}());\n}",
        ...
        {"var", "var ${1:name} = ${2:value};",
         "Variable"},
        {"final", "final ${1:name} = ${2:value};",
         "Final variable"},
        {"const", "const ${1:name} = ${2:value};",
         "Const variable"},
        {"late", "late ${1:Type} ${2:name};",
         "Late variable"},
        ...
        // Collections
        {"list", "List<${1:Type}> ${2:list} = [${3}];",
         "List"},
        {"map", "Map<${1:Key}, ${2:Value}> ${3:map} = {${4:key: value}};",
         "Map"},
        {"set", "Set<${1:Type}> ${2:set} = {${3}};",
         "Set"},
