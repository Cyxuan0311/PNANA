...
std::vector<Snippet> getLuaSnippets() {
    return {
        ...
        // Variables
        {"local", "local ${1:variable} = ${2:value}",
         "Local variable"},
        ...
        {"tablek", "${1:table} = {\n    [${2:key}] = ${3:value}\n}",
         "Table with key"},
        {"tablea", "${1:table} = {${2:value1}, ${3:value2}}",
         "Array table"},
        {"emptyt", "${1:table} = {}",
         "Empty table"},
        ...
        {"stringm", "[[${1:multiline text}]]",
         "Multiline string"},
        {"format", "string.format(\"${1:format}\", ${2:args})",
         "String format"},
        {"gsub", "string.gsub(${1:str}, \"${2:pattern}\", \"${3:replacement}\")",
         "String gsub"},
        {"match", "string.match(${1:str}, \"${2:pattern}\")",
         "String match"},
        {"find", "string.find(${1:str}, \"${2:pattern}\")",
         "String find"},
        {"len", "string.len(${1:str})",
         "String length"},
        {"sub", "string.sub(${1:str}, ${2:start}, ${3:end})",
         "String substring"},
        {"upper", "string.upper(${1:str})",
         "String uppercase"},
        {"lower", "string.lower(${1:str})",
         "String lowercase"},

        // Table Operations
        {"insert", "table.insert(${1:table}, ${2:value})",
         "Table insert"},
        {"remove", "table.remove(${1:table}, ${2:index})",
         "Table remove"},
        {"concat", "table.concat(${1:table}, \"${2:,}\")",
         "Table concat"},
        {"sort", "table.sort(${1:table})",
         "Table sort"},
        {"unpack", "table.unpack(${1:table})",
         "Table unpack"},

        // Modules
        {"module", "local ${1:module} = {}\n\nfunction ${1:module}.${2:function}()\n    ${3:// code}\nend\n\nreturn ${1:module}",
         "Module"},
        {"require", "local ${1:module} = require(\"${2:module}\")",
         "Require module"},
        ...
        {"getn", "#${1:table}",
         "Get table length"},
        {"next", "next(${1:table}, ${2:key})",
         "Next key-value pair"},
        {"pairs", "pairs(${1:table})",
         "Pairs iterator"},
        {"ipairs", "ipairs(${1:table})",
         "Ipairs iterator"},
