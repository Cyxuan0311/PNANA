...
if(TreeSitter_FOUND)
    ...
    if(TreeSitter_CSHARP_FOUND)
        set(TREE_SITTER_CSHARP_LIB ${TreeSitter_CSHARP_LIBRARY})
    endif()
    ...
    if(TreeSitter_ZIG_FOUND)
        set(TREE_SITTER_ZIG_LIB ${TreeSitter_ZIG_LIBRARY})
    endif()
    if(TreeSitter_C3_FOUND)
        set(TREE_SITTER_C3_LIB ${TreeSitter_C3_LIBRARY})
    endif()
    # 函数式/编译器相关语言支持映射
